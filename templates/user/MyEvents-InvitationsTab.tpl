            ...
            <td >
              <div style="margin:3%">
                ...
                <div id="stacker-container" class="column-group">  <!-- Stacker element -->
                  <div class="xlarge-20 large-20 medium-50 tiny-100 hide-small stacker-column">
                  ...
                  <div class="xlarge-20 large-20 medium-50 tiny-100 hide-medium hide-small stacker-column">
