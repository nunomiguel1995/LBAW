    ...
    <div class="all-80 small-100 tiny-100 push-center">
      <div id="createEvent" class="ink-carousel" data-pagination="#my-carousel-1-pagination" align="center">
        <h4> Create Event </h4>
        <form class="ink-form ink-formvalidator"	action="../../actions/event/AddEventAction.php" method="post">
                  ...
                  <div class="control-group all-70">
                    <div class="control">
                      ...
                      <div class="profilepic all-55">
                        ...
                        <input type="file" class="ink-button" type="button" accept="image/*">
                      </div>
                    </div>
                  </div>
                </li>
                                        ...
                                        <form class="ink-form">
                                            <fieldset>
                                                <div class="control-group">
                                                    <ul class="control unstyled">
                                                        <li><input type="checkbox" id="cb[]" name="{$user.username}" value="{$user.name}" onclick="addToArray2('{$user.username}','{$user.name}')"></li>
                                                    </ul>
                                                </div>
                                            </fieldset>
                                        </form>
